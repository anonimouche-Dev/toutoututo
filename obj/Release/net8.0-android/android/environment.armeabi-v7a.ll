...
@dso_cache = dso_local local_unnamed_addr global [570 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 140027674, ; hash 0x858a71a, from name: aot-toutoututo.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 316372594, ; hash 0x12db7672, from name: libaot-toutoututo
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-toutoututo.dll.so
		ptr null; void* handle (0x0)
	}, ; 36
	...
	%struct.DSOCacheEntry {
		i64 1227351834, ; hash 0x4927e71a, from name: toutoututo.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-toutoututo.dll.so
		ptr null; void* handle (0x0)
	}, ; 151
	...
	%struct.DSOCacheEntry {
		i64 2888392293, ; hash 0xac295e65, from name: libaot-toutoututo.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-toutoututo.dll.so
		ptr null; void* handle (0x0)
	}, ; 390
	...
	%struct.DSOCacheEntry {
		i64 2929092243, ; hash 0xae966693, from name: aot-toutoututo
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-toutoututo.dll.so
		ptr null; void* handle (0x0)
	}, ; 396
	...
	%struct.DSOCacheEntry {
		i64 3991664442, ; hash 0xedebf73a, from name: toutoututo
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-toutoututo.dll.so
		ptr null; void* handle (0x0)
	}, ; 532
