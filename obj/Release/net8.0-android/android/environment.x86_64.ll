...
@dso_cache = dso_local local_unnamed_addr global [570 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 62116371847643705, ; hash 0xdcae82d6b70239, from name: aot-toutoututo
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-toutoututo.dll.so
		ptr null; void* handle (0x0)
	}, ; 1
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 658004849305589908, ; hash 0x921b3ec97581894, from name: libaot-toutoututo.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-toutoututo.dll.so
		ptr null; void* handle (0x0)
	}, ; 18
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.69_name, ; name: libaot-System.IO.FileSystem.Watcher.dll.so
		ptr null; void* handle (0x0)
	}, ; 60
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.90_name, ; name: libaot-System.Xml.Linq.dll.so
		ptr null; void* handle (0x0)
	}, ; 93
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 3995907575959057186, ; hash 0x377450c4e454f322, from name: toutoututo.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-toutoututo.dll.so
		ptr null; void* handle (0x0)
	}, ; 120
	...
	%struct.DSOCacheEntry {
		i64 10659742494510600618, ; hash 0x93ef03522e70d1aa, from name: toutoututo
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-toutoututo.dll.so
		ptr null; void* handle (0x0)
	}, ; 317
	...
	%struct.DSOCacheEntry {
		i64 11616717323009774836, ; hash 0xa136dedb761fd4f4, from name: libaot-toutoututo
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-toutoututo.dll.so
		ptr null; void* handle (0x0)
	}, ; 354
	...
	%struct.DSOCacheEntry {
		i64 14385350121435766319, ; hash 0xc7a307b7f5cd1e2f, from name: aot-toutoututo.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-toutoututo.dll.so
		ptr null; void* handle (0x0)
	}, ; 457
...
@.env.3 = private unnamed_addr constant [37 x i8] c"865b36d7-4f0f-4cf0-9297-38b1758ebdf0\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [27 x i8] c"com.companyname.toutoututo\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [25 x i8] c"libaot-toutoututo.dll.so\00", align 16
...
@.DSOCacheEntry.69_name = private unnamed_addr constant [43 x i8] c"libaot-System.IO.FileSystem.Watcher.dll.so\00", align 16
...
@.DSOCacheEntry.90_name = private unnamed_addr constant [30 x i8] c"libaot-System.Xml.Linq.dll.so\00", align 16
